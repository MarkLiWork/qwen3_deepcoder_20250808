...
WANDB_PROJECT=qwen3-4b-t-code-grpo-deepcoder
EXP_NAME=32k-deepcoder-lcbv6-qwen3-4b-t-sync-b128
...
python3 -m verl.trainer.main_ppo \
    ...
    data.val_files=/mnt/nvme5n1/markli/projects/tranform_lcbv6/converted_data.json \
    ...
    trainer.validation_data_dir=/mnt/nvme5n1/markli/results/validation_results/${WANDB_PROJECT}/${EXP_NAME} \
    trainer.rollout_data_dir=/mnt/nvme5n1/markli/results/rollout_results/${WANDB_PROJECT}/${EXP_NAME} \
    trainer.default_local_dir=/mnt/nvme5n1/markli/results/${WANDB_PROJECT}/${EXP_NAME} "${@:1}" 